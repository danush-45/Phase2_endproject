...
import starpages.BuyNowPage;
import starpages.HomePage;
public class StepDefination {
public static String ph_no;
HomePage homePage = new HomePage(BaseTest.driver); BuyNowPage buyNowPage = new BuyNowPage(BaseTest.driver);

@Given("User launches the Star Health application with{string}")
public void
user_launches_the_star_health_application_with(String URL) {

BaseTest.driver.manage().window().maximize(); BaseTest.driver.get(URL);
...
public void user_validates_the_star_health_home_page_title_using_a_j_unit_ assertion() throws InterruptedException {
Thread.sleep(2000);
...
InterruptedException {
Thread.sleep(2000); buyNowPage.give_name(FullName);
}
...
public void user_validates_that_the_mobile_number_is_the_same_as_the_previ ously_entered_number_using_a_j_unit_assertion() throws InterruptedException { 
	Thread.sleep(3000);
